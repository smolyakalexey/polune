...
Статус: архивная спецификация макетов. Актуальные реализованные решения находятся в `IMPLEMENTATION_LOG.md`, методика — в `METHODOLOGY.md`, следующие задачи — в `TODO_V2.md`.
